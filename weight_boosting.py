...
class BaseWeightBoosting(six.with_metaclass(ABCMeta, BaseEnsemble)):
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        for iboost in range(self.n_estimators):
            # Boosting step
            sample_weight, estimator_weight, estimator_error, fairness = self._boost(
                iboost,
                X, y,
                sample_weight,
                random_state)
            ...
            self.calculate_weights(X, y, sample_weight)
    ...
    def calculate_weights(self, data, labels, sample_weight):
        ...
        # print "dp = " + str(protected_positive) + ", fp = " + str(non_protected_positive) +  ", dn = " + str(protected_negative) + ", fn = " + str(non_protected_negative)
...
class AdaBoostClassifier(BaseWeightBoosting, ClassifierMixin):
    ...
    def _boost_real(self, iboost, X, y, sample_weight, random_state):
        ...
        # print "fairness = " + str(self.calculate_fairness(X, y, y_predict)) + ", error = " + str(estimator_error)
        ...
        return sample_weight, 1., estimator_error, fairness
